...
public class Principal extends javax.swing.JFrame {
        ...
        private void customInit() {
                setTitle("Peluquería Canina - Panel Principal");
                setPreferredSize(new java.awt.Dimension(1020, 624));
                ...
                // Estilo de los botones (texto limpio sin emojis para evitar símbolos [])
                ThemeUtil.applyPrimaryButton(btnCargarDatos);
                btnCargarDatos.setText("Cargar Datos");
                btnCargarDatos.setFont(new java.awt.Font("Segoe UI", java.awt.Font.BOLD, 18));

                ThemeUtil.applySecondaryButton(btnVerDatos);
                btnVerDatos.setText("Ver Datos");
                btnVerDatos.setFont(new java.awt.Font("Segoe UI", java.awt.Font.BOLD, 18));

                ThemeUtil.applyOutlineButton(btnSalir);
                btnSalir.setText("Salir");
                btnSalir.setFont(new java.awt.Font("Segoe UI", java.awt.Font.BOLD, 16));

                jSeparator1.setVisible(false);

                // Escalar la imagen suavemente para que encaje completa sin cortarse
                try {
                        java.net.URL imgURL = getClass().getResource("/img/peluqueria-canina.png");
                        if (imgURL != null) {
                                javax.swing.ImageIcon originalIcon = new javax.swing.ImageIcon(imgURL);
                                java.awt.Image img = originalIcon.getImage();
                                java.awt.Image scaledImg = img.getScaledInstance(290, 290, java.awt.Image.SCALE_SMOOTH);
                        ...
                        System.err.println("Error al escalar imagen: " + ex.getMessage());
                }
        ...
        private void initComponents() {
                ...
                btnCargarDatos.setText("Cargar datos");
                btnCargarDatos.setBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.LOWERED,
                                new java.awt.Color(51, 0, 204), new java.awt.Color(51, 0, 102), null, null));
                ...
                jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/peluqueria-canina.png"))); // NOI18N
                ...
                btnVerDatos.setText("Ver datos");
                btnVerDatos.setBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.LOWERED,
                                new java.awt.Color(51, 0, 204), new java.awt.Color(51, 0, 102), null, null));
